...
'''
Игра. Загадывает трёхзначное число. Нужно угадать за заданное число попыток.
Если цифры числа совпадают, но стоят не на своих местах, выводит одно сообщение.
Если не совпадают совсем - другое.
Если цифра стоит на своём месте, выводит третье сообщение.
'''
